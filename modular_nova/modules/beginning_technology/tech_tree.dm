...
/datum/beginning_technology
	...
	var/list/required_crafting = list(/obj/item/stack/sheet/iron)
...
/datum/beginning_technology/part_casing
	...
	required_crafting = list(/obj/item/stack/sheet/iron)

/datum/beginning_technology/capacitor_plate
	researched_item = /obj/item/research_item/capacitor_plate
	required_crafting = list(/obj/item/stack/sheet/iron, /obj/item/paper)
...
/datum/beginning_technology/laser_lens
	...
	required_crafting = list(/obj/item/stack/sheet/glass)
...
/datum/beginning_technology/t1_capacitor
	...
	required_crafting = list(/obj/item/research_item/capacitor_plate, /obj/item/research_item/part_casing)

/datum/beginning_technology/t1_servo
	researched_item = /obj/item/stock_parts/servo
	required_crafting = list(/obj/item/research_item/servo_motor, /obj/item/research_item/part_casing)

/datum/beginning_technology/t1_matterbin
	researched_item = /obj/item/stock_parts/matter_bin
	required_crafting = list(/obj/item/stack/sheet/iron, /obj/item/research_item/part_casing)

/datum/beginning_technology/t1_microlaser
	researched_item = /obj/item/stock_parts/micro_laser
	required_crafting = list(/obj/item/research_item/laser_lens, /obj/item/research_item/part_casing)

/datum/beginning_technology/t1_scanningmod
	researched_item = /obj/item/stock_parts/scanning_module
	required_crafting = list(/obj/item/research_item/laser_lens, /obj/item/research_item/part_casing)
	required_techs = list(/datum/beginning_technology/t1_microlaser)

/datum/beginning_technology/t1_powercell
	researched_item = /obj/item/stock_parts/power_store/cell/lead
	required_crafting = list(/obj/item/research_item/capacitor_plate, /obj/item/research_item/part_casing)
	required_techs = list(/datum/beginning_technology/t1_capacitor)

/datum/beginning_technology/cable
	researched_item = /obj/item/stack/cable_coil/five
	required_crafting = list(/obj/item/stack/sheet/iron, /obj/item/stack/sheet/mineral/gold)
...
/datum/beginning_technology/computer_chip
	...
	required_crafting = list(/obj/item/forging/complete/plate)
	required_tool = /obj/item/screwdriver
	required_techs = list(/datum/beginning_technology/part_casing)

/datum/beginning_technology/empty_circuit
	researched_item = /obj/item/research_item/empty_circuit
	required_crafting = list(/obj/item/research_item/computer_chip, /obj/item/forging/complete/plate)
	required_techs = list(/datum/beginning_technology/computer_chip)
